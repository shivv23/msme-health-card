  ...
  return (
    <Card className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Badge variant={credit.eligible ? 'green' : 'red'}>
      ...
      {credit.eligible && (
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="rounded-lg bg-slate-800/50 p-4 text-center">
            ...
            <p className="text-xl font-bold text-slate-100">{credit.tenure_months} months</p>
          </div>
          <div className="rounded-lg bg-slate-800/50 p-4 text-center">
            <p className="text-xs text-slate-500 mb-1">Interest Rate</p>
            <p className="text-xl font-bold text-blue-400">{credit.interest_rate}% p.a.</p>
          </div>
        </div>
      )}

      {credit.risk_factors.length > 0 && (
        <div>
          ...
          <ul className="space-y-1.5">
            {credit.risk_factors.map((factor, i) => (
      ...
      <div className="flex gap-3 pt-2">
        ...
        <Button variant="secondary" onClick={onViewReport} className={!credit.eligible ? 'flex-1' : ''}>
          <FileText size={16} />
